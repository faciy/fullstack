...
describe('mostBlog', () => {
  ...
  test('of a bigger blog of author', () => {
...
describe('mostLikes', () => {
  test('of empty list Likes is null', () => {
    const listWithZeroBlog =[]
    const result = listHelper.mostLikes(listWithZeroBlog)
    expect(result).toBe(undefined)
  })
  test('when list has only one list equals that', () => {
  ...
  test('of a bigger likes of blogs of author',() => {
